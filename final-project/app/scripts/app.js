...
// App Module: the name FinalProjectApp matches the ng-app attribute in the main <html> tag
...
storeApp.factory('DataService', function () {
    ...
    var myCart = new shoppingCart('FinalProjectApp');
...
// FinalProjectApp.controller('mainController', ['$scope', function($scope) {
